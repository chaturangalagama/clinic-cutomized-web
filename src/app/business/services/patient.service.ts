...
import { MedicalAlerts } from '../../app/util/objects/request/MedicalAlerts';
...
import { COUNTRIES } from '../../app/util/constants/countries';
import { COMMUNICATIONS } from '../../app/util/constants/communications';
import { ETHNICITIES } from '../../app/util/constants/ethnicities';
import { GENDERS } from '../../app/util/constants/genders';
import { LANGUAGES } from '../../app/util/constants/languages';
import { MARITAL_STATUS } from '../../app/util/constants/marital.status';
import { NATIONALITIES } from '../../app/util/constants/nationalities';
import { OCCUPATIONS } from '../../app/util/constants/occupations';
import { TITLES } from '../../app/util/constants/titles';
