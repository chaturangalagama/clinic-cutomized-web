...
import { PatientNoteAdd } from '../../app/util/objects/request/PatientNoteAdd';
// import { API_URL, API_CMS_MANAGEMENT_URL } from './../constants/app.constants';
import { Observable } from 'rxjs';
import { HttpResponseBody } from '../../app/util/objects/response/HttpResponseBody';
...
export class ApiCmsManagementService {
  ...
  listDefaultVitals(): Observable<HttpResponseBody> {
    return this.http.post<HttpResponseBody>(
      `${this.API_CMS_MANAGEMENT_URL}/system-config/list/vitals/default`,
      {},
      { headers: this.headers }
    );
  }
