...
export class ConsultationHistoryItemComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if(this.patientVisitHistory.patientReferralEntity.diagnosisIds){
      this.apiCmsManagementService.searchDiagnosisByIds(this.patientVisitHistory.patientReferralEntity.diagnosisIds).subscribe(
        res => {
    ...
    this.patientVisitHistory.patientReferralEntity.dispatchItemEntities.forEach( item => {
  ...
  onCopyPrescriptionClicked(){
    console.log("#0012 copy prescription clicked: ",this.patientVisitHistory.patientReferralEntity);
    this.copyPrescription.emit(this.patientVisitHistory.patientReferralEntity);
  }
